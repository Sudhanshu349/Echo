const socket = io(); // Connect to same host automatically
...
// Ask for name and room
const name = prompt("Enter your name:");
const room = prompt("Enter room name to join:");
socket.emit('join-room', { name, room });

// Socket events
socket.on('user-joined', name => append(`${name} joined the room`, 'right'));
...
socket.on('user-left', name => append(`${name} left the room`, 'right'));
